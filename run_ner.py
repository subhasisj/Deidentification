...
class DataTrainingArguments:
    ...
    umls: bool = field(
        default=False, metadata={"help": "whether we inject medical knowledge in the training of the bert model"}
    )

    med_document: str = field(
        default=None,
        metadata={"help": "the file name of augment vocabulary using UMLS structure."},
    )
...
def create_cui_dict(voc_updated, tokenizer):
    tui_ids = {}
